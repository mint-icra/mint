...
- optional MuJoCo and Dexterous Hand panels when their dependencies/assets exist.

For a LeRobot episode with ground truth, the four selected export categories
(2D, fixed-world 3D, MuJoCo, and Dexterous Hand) can be downloaded either as one
